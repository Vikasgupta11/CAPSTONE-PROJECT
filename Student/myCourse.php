...
?>
<div class="container mt-5 ml-4 col-sm-10">
<div class="row">
    <div class="jumbotron">
...
while($row=$result->fetch_assoc()){?>
    ...
    <div class="bg-light mb-3">
        ...
        <div>
            <div class="col-sm-3" style="display:inline;">
                <img src="<?php echo($row["course_img"]);  ?>" class="card-img-top mt-4" style="width:250px;" alt="pic">
    ...
    <div class="col-sm-6 mb-3" style="float-left;">
        <div class="card-body" >
            ...
            <small class="card-text">Duration: <?php echo($row['course_duration']) ?><br></small>
...
?>
 ...
 </div>  <!-- Close Row div From Haeder file -->
